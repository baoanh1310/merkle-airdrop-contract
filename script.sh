...
# near call merkle.icebear.testnet claim '{"airdrop_id": 1, "proof": [{ "position": "left", "data": "413a4943f4b810d97809d5408ca04dfe8b96fe48398167bdd3fc85c49b0fe3cb" }, { "position": "right", "data": "6625f781853af79d731d131748e19c53e1959a1ffcef2870b8e8e74da3df0885" }], "amount": 20}' --accountId ceus.testnet
# near view merkle.icebear.testnet check_issued_account '{"airdrop_id": 1, "account_id": "icebear.testnet"}'
# near call merkle.icebear.testnet get_ft_decimals '{"airdrop_id": 1, "account_id": "icebear.testnet", "amount": "10000"}' --accountId icebear.testnet
